            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block ml-10">
                    <div class="flex items-baseline space-x-4">
                        ...
                        <a href="/Activition/catalog.php" class="hover:bg-blue-800 px-3 py-2 rounded-md text-sm font-medium transition-colors">Catalog</a>
                    </div>
                </div>
            </div>
            <div class="flex items-center space-x-4">
                <a href="/Activition/checkout.php" class="flex items-center gap-1 hover:text-accent transition-colors">
