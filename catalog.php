...
<div class="bg-primary text-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-4xl font-extrabold mb-4">Product Catalog</h1>
    ...
    <div class="flex flex-col md:flex-row gap-8">
        ...
        <div class="w-full md:w-64 flex-shrink-0">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-6">
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="/Activition/catalog.php" class="block text-sm transition-colors <?php echo empty($category_filter) ? 'text-accent font-bold' : 'text-gray-600 hover:text-primary'; ?>">
                            All Products
                        </a>
                    </li>
                    <?php foreach ($categories as $cat): ?>
                        <li>
                            <a href="/Activition/catalog.php?category=<?php echo urlencode($cat['slug']); ?>" 
                            ...
                            <div class="p-5 flex-1 flex flex-col">
                                ...
                                <div class="flex justify-between items-end mt-auto pt-4 border-t border-gray-100">
                                    ...
                                    <?php if ($product['stock'] > 0): ?>
                                        <a href="/Activition/checkout.php?product_id=<?php echo $product['id']; ?>" class="bg-gray-900 hover:bg-accent text-white py-2 px-4 rounded-lg text-sm font-bold transition-colors shadow">
                                            Buy Now
                                        </a>
                                    <?php else: ?>
